var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_style(div0, "width", /*progress*/ ctx[0] / /*total*/ ctx[1] * 100 + "%");
    ...
    class ProgressBar extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$3, safe_not_equal, { progress: 0, total: 1 });
    	}
    }

    /* src/Timer.svelte generated by Svelte v3.44.3 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*secondsLeft*/ 2) set_data(t0, /*secondsLeft*/ ctx[1]);
    			const progressbar_changes = {};
    			if (dirty & /*secondsLeft*/ 2) progressbar_changes.progress = /*secondsLeft*/ ctx[1];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$invalidate(1, secondsLeft = totalSeconds);
    	return [isRunning, secondsLeft, startTimer];
    }
    ...
    /* src/HowTo.svelte generated by Svelte v3.44.3 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="how_to_handwash_lge.gif" alt="How to wash your hands" class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			h3 = element("h3");
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en">Picture Source</a>  <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Attribution</a>`;
    			t7 = space();
    			audio_1 = element("audio");
    			audio_1.innerHTML = `<source src="345086__metrostock99__oh-yeah-low-4.wav"/>`;
    			attr(h1, "class", "svelte-1vueshc");
    			attr(h3, "class", "svelte-1vueshc");
    		},
    		m(target, anchor) {
